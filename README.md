...
Climate Earth is an interactive climate visualization tool that maps global temperature trends from **1850 through 2100**.
...
While inspired by the same data used by the Intergovernmental Panel on Climate Change (IPCC), the Climate Earth is built for accessibility:
